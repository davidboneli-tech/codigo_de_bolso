...
**380 fichas · 28 categorias · Versão 0.6.2**
...
**Versão documentada: 0.6.2.** O manifesto define Android 8.0 como versão mínima. A compatibilidade precisa ser verificada no aparelho; não há declaração de testes em todos os modelos Android.

A versão 0.6.2 acrescenta 55 ilustrações e destaque de comandos, com 1.226 verificações de interface em Chromium e assinatura do APK verificada. A instalação da 0.6.2 no aparelho ainda precisa ser conferida.
